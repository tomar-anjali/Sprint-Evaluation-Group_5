...
public class GroomingServiceServiceImplementation implements GroomingServiceService{
	...
	public ResponseEntity<ResponseStructure<List<GroomingServiceResponseDto>>> getAllGroomingService(){
		...
		if(!groomingService.isEmpty()) {
			List<GroomingServiceResponseDto> groomingServiceResponseDto = groomingService.stream().map(groomingServices -> {
    ...
    @Override
    public ResponseEntity<ResponseStructure<GroomingServiceResponseDto>> updateGroomingService(int serviceId, GroomingServiceResponseDto groomingServiceDto) {
